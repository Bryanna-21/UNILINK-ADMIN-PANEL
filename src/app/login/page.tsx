  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      if (user.role !== "admin" && user.role !== "superadmin") {
        // Authentication succeeded, but this account has no admin access.
        // Do not sign them into the panel's auth store at all — send them
        // to /unauthorized without a session, rather than create a token
        // in localStorage for an account that can't use it.
